...
public class Device extends TestBase {
	...
	// 4 跳转 设备页，点击左侧导航中，新消息按钮 能否成功跳转到新消息列表页
	@Test
	...
	// 5 跳转 设备页，点击左侧导航中，历史消息按钮 能否成功跳转到历史消息页
	@Test
	...
	// 6 跳转 设备页，点击左侧导航中，相框按钮 能否成功跳转到相框页面
	@Test
	...
	// 8 跳转 跳转 设备页，点击左侧导航中，合作伙伴按钮 能否成功跳转到合作伙伴页面
	@Test
	...
	// 12 跳转 设备页，点击退出按钮 能否成功退出消息中心，回到登录页面
	@Test
	...
	public void beforeMethod() throws InterruptedException {
		...
		wb.get("http://testmcenter.weixinxk.com/admin/statistic/device/index");
		Thread.sleep(1000);
